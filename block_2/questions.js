const questions = [
  {
    ...
    answers: [".bashrc"],
    type: "radio",
    translation: "Este archivo se invoca como shell interactiva no login",
  ...
  },
  {
    ...
    answers: ["PATH"],
    type: "radio",
    translation: "Esta variable de entorno contiene la lista de directorios que se buscan al ejecutar comandos",
  ...
  {
    question: 'Which commands allow you to find files, that contain a word "ping" in the current directory?',
    options: ["find . -n ping -type f", "grep -r ping .", "grep -r ping", "find -name ping -t f"],
    answers: ["grep -r ping .", "grep -r ping"],
    type: "checkbox",
    translation: 'Qué comandos permiten encontrar archivos que contengan la palabra "ping" en el directorio actual',
  ...
  },
  {
    ...
    answers: ["Can convert lines into single line"],
    type: "radio",
  ...
  },
  {
    ...
    type: "checkbox",
    translation: "Selecciona los comandos que crearán un archivo (archive)",
